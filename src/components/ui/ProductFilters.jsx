  ...
  return (
    <div className="bg-[#0C2430] border border-white/10 rounded-xl p-6 mb-10 shadow-2xl animate-in fade-in slide-in-from-top-4 duration-300">
      <div className="flex justify-between items-center mb-6 pb-4 border-b border-white/5">
        ...
        <div className="flex gap-4">
          <button
            ...
            className="text-[var(--muted-gray)] hover:text-[var(--accent-yellow)] text-xs uppercase font-bold tracking-wide flex items-center gap-1 transition-colors"
          >
            <X size={14} /> Clear All
          </button>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
        {/* Connection Mode */}
        <div>
          <label className="block text-[var(--accent-yellow)] text-xs font-bold uppercase tracking-wider mb-3">
            Connection Mode
          </label>
            ...
            {filterOptions.connectionModes.map((mode) => (
              ...
              >
                <input
                  ...
                  className="mr-3 appearance-none size-4 border border-white/20 rounded-sm checked:bg-[var(--accent-yellow)] checked:border-[var(--accent-yellow)] transition-all cursor-pointer relative"
                />
          ...
          <div className="flex gap-4">
            <div className="flex-1">
              <input
                ...
                className="w-full bg-[var(--bg-dark)] border border-white/20 rounded px-3 py-2 text-white placeholder-white/30 focus:border-[var(--accent-yellow)] focus:outline-none focus:ring-1 focus:ring-[var(--accent-yellow)] text-sm"
              />
            </div>
            <div className="flex-1">
              <input
